...
**** preconditions                                      :generic:function:
#+BEGIN_SRC emacs-lisp
...
**** update-properties                                  :generic:function:
#+BEGIN_SRC emacs-lisp
...
**** check-preconditions                                   :reader:method:
#+BEGIN_SRC emacs-lisp
...
**** update-properties                                     :writer:method:
#+BEGIN_SRC emacs-lisp
...
***** TODO active-days                                    :reader:method:
#+BEGIN_SRC emacs-lisp
