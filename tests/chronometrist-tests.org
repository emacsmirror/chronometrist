...
(ert-deftest chronometrist-backend-tests ()
  (unwind-protect
      (progn
        ...
        (should-error (chronometrist-task-records-for-date chronometrist-test-backend "Test" (chronometrist-date-iso)))
        (should-error (chronometrist-active-days chronometrist-test-backend "Test"))
