...
=to-list= could omit them, since it has no concept of dates. =to-hash-table= could have them at the start of the lists of plists, i.e. hash values would be =(cdr <plist group>)=.
